...
public interface ISequentialInStream extends Closeable {
    /**
     * Reads at least 1 and maximum <code>len</code> bytes from the in-stream. If <code>len == 0</code>
     * 0 should be returned. If <code>len != 0</code>, then return value 0 indicates end-of-stream (EOF). This
     ...
     * <code>len</code>. You must call <code>read()</code> function in loop, if you need exact amount of data.<br>
     * <br>
     ...
     * 
     * @param data
     *            buffer to get read data (DirectByteBuffer backed by native memory)
     * @param len
     *            maximum amount of bytes to read
     * 
     * @return amount of bytes written in the <code>data</code> buffer. 0 - represents end of stream.
     * 
